            ...
            >
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">contact@investmentcompanion.com</p>
                  </div>
                </div>
              ...
              <div className="glass-card p-6 rounded-lg">
                ...
                <div className="flex gap-4">
                  <motion.a
                    href="#"
                    className="w-10 h-10 rounded-full bg-[#081e28] flex items-center justify-center text-cyan-400 hover:bg-gradient-to-br hover:from-cyan-500 hover:to-blue-500 hover:text-white transition-colors border border-cyan-500/20"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-[#081e28] border border-gray-700 rounded-md px-4 py-3 text-white focus:outline-none focus:border-cyan-500 transition-colors"
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="ebook">E-Book Questions</option>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        rows={6}
                        className="w-full bg-[#081e28] border border-gray-700 rounded-md px-4 py-3 text-white focus:outline-none focus:border-cyan-500 transition-colors resize-none"
                    ...
                    <motion.button
                      ...
                      className="w-full button-gradient py-4 px-8 rounded-md text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed"
